...
class TokenV3Test {
    ...
    fun `Deserialization throws on wrong V3 prefixes`() {
        ...
        assertFailsWith<IllegalArgumentException> {
            TokenV3.Companion.deserialize("")
        }
